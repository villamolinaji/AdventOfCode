...
foreach (string line in lines)
{
    ...
    {
        //currentFolder = new Folder() { Files = new List<FileClass>(), Folders = new List<Folder>(), FolderName = line.Substring(3), TotalSize = 0 };
    ...
    else
    {
        ...
        /*currentFolder.TotalSize = currentFolder.TotalSize + int.Parse(line.Substring(0, line.IndexOf(" ")));
        foreach(var folderAux in prevFolders)
        {
            folderAux.TotalSize = folderAux.TotalSize + int.Parse(line.Substring(0, line.IndexOf(" ")));
        }*/
    }
}
