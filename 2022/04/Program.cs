...
foreach (var line in lines)
{
    ...
    /*var section1 = line.Substring(0, line.IndexOf('-'));
    var section2 = line.Substring(line.IndexOf('-') + 1, line.IndexOf(',') - 2);
    var section3 = line.Substring(line.IndexOf(',') + 1, (line.IndexOf('-', line.IndexOf(',')) - 1) - (line.IndexOf(',')));
    var section4 = line.Substring(line.IndexOf('-', line.IndexOf(',')) + 1, (line.Length - (line.IndexOf('-', line.IndexOf(',')))) - 1);*/
